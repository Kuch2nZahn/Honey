...
public class RequestServerConnectionResponderPacket extends RespondingPacket<RequestServerConnectionS2CPacket> {
    public RequestServerConnectionResponderPacket(String senderUUID, HoneyPacket toSend, Class<RequestServerConnectionS2CPacket> responseType, Consumer<RequestServerConnectionS2CPacket> callback) {
        super(senderUUID, toSend, responseType, callback);
    }
}
